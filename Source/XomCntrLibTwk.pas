...
type
  ...
  XTypes = (XNone,
    ...
    EFMV_CreateBriefingBoxEventContainer,
    ...
    EFMV_RaiseWaterEventContainer,
    EFMV_SelectWeaponEventContainer,
    EFMV_SelectWormEventContainer,
...
'kMT_MemoryNormalBorder','kMT_MemoryHighlightBorder','kMT_MemoryHighlightDisabled','kMT_ComPanelBorderTrans','kMT_LAST');
 ...
 XResourceDetailsTypes: array [0..7] of String = ('IntResources','UintResources','StringResources',
